...
(
	...
	-- UPDATE 
	v_tipo_funcion varchar(100) NOT NULL
)
;
...
(
	...
	-- UPDATE
	v_genero varchar(150) NOT NULL,
	v_clasificacion varchar(50) NOT NULL,
	v_reparto varchar(500) NOT NULL,
	v_director varchar(100) NOT NULL,
	d_fecha_estreno date NOT NULL,
	v_pais_origen varchar(100) NOT NULL,
	--- 
	i_duracion integer NOT NULL,
	tx_sinapsis text NOT NULL,
	v_foto varchar NOT NULL
)
;
-- crear la llave primaria 
CREATE TABLE Tipo_documento
(
	pk_id_tipo integer NOT NULL,
	v_tipo varchar(50) NOT NULL,
	constraint tipo_documento_pk primary key (pk_id_tipo)
);
...
(
	...
	v_segundoApellido varchar(100) NULL,
	i_telefono bigint NOT NULL,
	v_direccion varchar(100) NOT NULL,
	v_pass varchar(128) NOT NULL,
	-- correo electronico
	v_correo_electronico varchar(200),
	v_foto varchar NOT NULL
)
;
--Tipo documento 
...
ALTER TABLE Persona ADD CONSTRAINT PK_Persona
	PRIMARY KEY (pk_numero_documento)
;
...
ALTER TABLE Cliente ADD CONSTRAINT FK_Cliente_Persona
	FOREIGN KEY (fk_persona) REFERENCES Persona (pk_numero_documento) ON DELETE No Action ON UPDATE No Action
;
